...
from AuraXUserbot import CMD_LIST, LOAD_PLUG, LOGS, SUDO_LIST, bot
from AuraXUserbot.helpers.exceptions import CancelProcess
    ...
    if pattern is not None:
        if pattern.startswith(r"\#"):
            ...
            if len(Config.COMMAND_HAND_LER) == 2:
                AuraXreg = "^" + Config.COMMAND_HAND_LER
