...
async def carbon_api(e):
    ...
    AuraX = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await AuraX.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await AuraX.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await AuraX.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by AuraXBot",
        force_document=True,
...
async def carbon_api(e):
    if e.fwd_from:
        return
    AuraX = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await AuraX.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = Config.CHROME_BIN
...
async def carbon_api(e):
    ...
    await AuraX.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await AuraX.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await AuraX.delete()  # Deleting msg
...
async def carbon_api(e):
    ...
    await AuraX.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await AuraX.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await AuraX.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await AuraX.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await AuraX.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await AuraX.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await AuraX.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await AuraX.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await AuraX.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await AuraX.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
