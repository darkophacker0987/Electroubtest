...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](AuraXNetwork/AuraXBot)**",
        ...
        "__INFO:AuraXBot:Logged in as 557667062__",
        "__INFO:AuraXBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
