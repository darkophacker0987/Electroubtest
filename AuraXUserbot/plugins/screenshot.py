...
async def _(event):
    ...
    try:
        ...
        with io.BytesIO(im_png) as out_file:
            out_file.name = "AuraXBot.ScreenCapture.PNG"
...
CmdHelp("screenshot").add_command(
  "screenshot", "<link>", "Gives out the web screenshot of given link via Google Crome Bin in .png format", ".screenshot https://github.com/PyCodents/AuraXUserbot"
).add()