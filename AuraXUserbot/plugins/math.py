...
@AuraXBot.on(admin_cmd(pattern="sin ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@AuraXBot.on(admin_cmd(pattern="cos ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@AuraXBot.on(admin_cmd(pattern="tan ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@AuraXBot.on(admin_cmd(pattern="cosec ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@AuraXBot.on(admin_cmd(pattern="sec ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@AuraXBot.on(admin_cmd(pattern="cot ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@AuraXBot.on(admin_cmd(pattern="square ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@AuraXBot.on(admin_cmd(pattern="cube ?(.*)"))
@AuraXBot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
